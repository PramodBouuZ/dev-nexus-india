...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Structured marketplace to hire vetted part-time and project developers in India. Post a project, match instantly, hire fast." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "HireSpark — Hire part-time developers in India" },
      { name: "twitter:description", content: "Structured marketplace to hire vetted part-time and project developers in India. Post a project, match instantly, hire fast." },
